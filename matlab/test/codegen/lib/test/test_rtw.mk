...
## Generated on : Wed Nov 11 11:31:27 2020
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/cccc2020/CODE/human_detect/matlab/test/codegen/lib/test
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=test
DEFINES_CUSTOM = 
...
OBJS = test_initialize.o test_terminate.o test.o
...
%.o : D:/cccc2020/CODE/human_detect/matlab/test/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/test/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : D:/cccc2020/CODE/human_detect/matlab/test/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/test/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : D:/cccc2020/CODE/human_detect/matlab/test/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


test_initialize.o : $(START_DIR)/test_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test_terminate.o : $(START_DIR)/test_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test.o : $(START_DIR)/test.c
	$(CC) $(CFLAGS) -o "$@" "$<"
