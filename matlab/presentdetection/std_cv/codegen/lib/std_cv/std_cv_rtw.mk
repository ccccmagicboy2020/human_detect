###########################################################################
## Makefile generated for MATLAB file/project 'std_cv'. 
## 
## Makefile     : std_cv_rtw.mk
## Generated on : Wed Nov 18 15:32:40 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: ./std_cv.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/cccc2020/CODE/human_detect/matlab/presentdetection/std_cv/codegen/lib/std_cv
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = std_cv_rtw_comp.rsp
CMD_FILE                  = std_cv_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = std_cv.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=std_cv
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=std_cv
...
SRCS = $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c $(START_DIR)/std_cv_data.c $(START_DIR)/std_cv_initialize.c $(START_DIR)/std_cv_terminate.c $(START_DIR)/std_cv.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o std_cv_data.o std_cv_initialize.o std_cv_terminate.o std_cv.o
...
%.o : D:/cccc2020/CODE/human_detect/matlab/presentdetection/std_cv/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/presentdetection/std_cv/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : D:/cccc2020/CODE/human_detect/matlab/presentdetection/std_cv/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/presentdetection/std_cv/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : D:/cccc2020/CODE/human_detect/matlab/presentdetection/std_cv/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
std_cv_data.o : $(START_DIR)/std_cv_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


std_cv_initialize.o : $(START_DIR)/std_cv_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


std_cv_terminate.o : $(START_DIR)/std_cv_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


std_cv.o : $(START_DIR)/std_cv.c
	$(CC) $(CFLAGS) -o "$@" "$<"
