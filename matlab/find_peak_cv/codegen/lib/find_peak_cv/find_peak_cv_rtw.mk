...
## Build Info:
## 
## Final product: ./find_peak_cv.lib
...
PRODUCT_NAME              = find_peak_cv
MAKEFILE                  = find_peak_cv_rtw.mk
MATLAB_ROOT               = D:/Program Files/Polyspace/R2020a
MATLAB_BIN                = D:/Program Files/Polyspace/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/cccc2020/CODE/human_detect/matlab/find_peak_cv/codegen/lib/find_peak_cv
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = find_peak_cv_rtw_comp.rsp
CMD_FILE                  = find_peak_cv_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = find_peak_cv.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=find_peak_cv
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=find_peak_cv
...
%.o : D:/cccc2020/CODE/human_detect/matlab/find_peak_cv/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/find_peak_cv/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : D:/cccc2020/CODE/human_detect/matlab/find_peak_cv/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/find_peak_cv/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : D:/cccc2020/CODE/human_detect/matlab/find_peak_cv/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
find_peak_cv_data.o : $(START_DIR)/find_peak_cv_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


find_peak_cv_initialize.o : $(START_DIR)/find_peak_cv_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


find_peak_cv_terminate.o : $(START_DIR)/find_peak_cv_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


find_peak_cv.o : $(START_DIR)/find_peak_cv.c
	$(CC) $(CFLAGS) -o "$@" "$<"
