###########################################################################
## Makefile generated for MATLAB file/project 'auto_trip_50hz'. 
## 
## Makefile     : auto_trip_50hz_rtw.mk
## Generated on : Wed Nov 11 16:25:47 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: ./auto_trip_50hz.lib
...
PRODUCT_NAME              = auto_trip_50hz
MAKEFILE                  = auto_trip_50hz_rtw.mk
MATLAB_ROOT               = D:/Program Files/Polyspace/R2020a
MATLAB_BIN                = D:/Program Files/Polyspace/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/cccc2020/CODE/human_detect/matlab/auto_trip_50hz/codegen/lib/auto_trip_50hz
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = auto_trip_50hz_rtw_comp.rsp
CMD_FILE                  = auto_trip_50hz_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = auto_trip_50hz.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=auto_trip_50hz
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=auto_trip_50hz
...
SRCS = $(START_DIR)/auto_trip_50hz_initialize.c $(START_DIR)/auto_trip_50hz_terminate.c $(START_DIR)/auto_trip_50hz.c
...
OBJS = auto_trip_50hz_initialize.o auto_trip_50hz_terminate.o auto_trip_50hz.o
...
%.o : D:/cccc2020/CODE/human_detect/matlab/auto_trip_50hz/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/auto_trip_50hz/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : D:/cccc2020/CODE/human_detect/matlab/auto_trip_50hz/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/auto_trip_50hz/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : D:/cccc2020/CODE/human_detect/matlab/auto_trip_50hz/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


auto_trip_50hz_initialize.o : $(START_DIR)/auto_trip_50hz_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


auto_trip_50hz_terminate.o : $(START_DIR)/auto_trip_50hz_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


auto_trip_50hz.o : $(START_DIR)/auto_trip_50hz.c
	$(CC) $(CFLAGS) -o "$@" "$<"
