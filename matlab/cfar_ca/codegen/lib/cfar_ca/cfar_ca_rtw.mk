...
PRODUCT_NAME              = cfar_ca
MAKEFILE                  = cfar_ca_rtw.mk
MATLAB_ROOT               = D:/Program Files/Polyspace/R2020a
MATLAB_BIN                = D:/Program Files/Polyspace/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/cccc2020/CODE/human_detect/matlab/cfar_ca/codegen/lib/cfar_ca
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = cfar_ca_rtw_comp.rsp
CMD_FILE                  = cfar_ca_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = cfar_ca.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=cfar_ca
DEFINES_CUSTOM = 
...
DEFINES_STANDARD = -DMODEL=cfar_ca
...
%.o : D:/cccc2020/CODE/human_detect/matlab/cfar_ca/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/cfar_ca/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : D:/cccc2020/CODE/human_detect/matlab/cfar_ca/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : D:/cccc2020/CODE/human_detect/matlab/cfar_ca/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
cfar_ca_terminate.o : $(START_DIR)/cfar_ca_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cfar_ca.o : $(START_DIR)/cfar_ca.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cfar_ca_emxutil.o : $(START_DIR)/cfar_ca_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cfar_ca_emxAPI.o : $(START_DIR)/cfar_ca_emxAPI.c
	$(CC) $(CFLAGS) -o "$@" "$<"
