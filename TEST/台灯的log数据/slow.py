...
#    check_p5('无人5min_闯入后坐1min_无人5min_t3276.log')       
    ...
    print('--------------台灯1.5m5min.log---------------')
    print("{:s}\t{:s}\t{:s}\t{:s}\t{:s}".format('len', 'max', 'min', 'avg', 'median'))
    check_p0('台灯1.5m5min.log')
    check_p1('台灯1.5m5min.log')
    check_p2('台灯1.5m5min.log')
    check_p3('台灯1.5m5min.log')
    check_p4('台灯1.5m5min.log')  
    check_p5('台灯1.5m5min.log')  
