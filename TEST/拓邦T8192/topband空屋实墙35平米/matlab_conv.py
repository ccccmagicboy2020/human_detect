...
def check_all():
    conv_to_csv('p0', 'topband.log')
    conv_to_csv('p1', 'topband.log')
    conv_to_csv('p2', 'topband.log')
    conv_to_csv('p3', 'topband.log')
    conv_to_csv('p4', 'topband.log', 38)
    conv_to_csv('p5', 'topband.log')
