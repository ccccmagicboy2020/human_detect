...
def check_all():
    ...
    check_p0('灯放会议室石膏墙对面有人.log')
    check_p1('灯放会议室石膏墙对面有人.log')
    check_p2('灯放会议室石膏墙对面有人.log')
    check_p3('灯放会议室石膏墙对面有人.log')
    check_p4('灯放会议室石膏墙对面有人.log')    
    print('--------------灯放会议室2---------------')
    print("{:s}\t{:s}\t{:s}\t{:s}\t{:s}".format('len', 'max', 'min', 'avg', 'median'))
    check_p0('灯放会议室隔壁两间没有人.log')
    check_p1('灯放会议室隔壁两间没有人.log')
    check_p2('灯放会议室隔壁两间没有人.log')
    check_p3('灯放会议室隔壁两间没有人.log')
    check_p4('灯放会议室隔壁两间没有人.log')  
