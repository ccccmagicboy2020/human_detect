...
def check_all():
    ...
    with open('fast_result.txt', 'w', encoding='UTF-8') as ff:
        ff.write('--------------台灯1米外---------------\n')
        print('--------------台灯1米外---------------')
        a, b, c, d, e = check_p0('快检测台灯1米外.log')
        if 1000 < a:
            temp_str = "p0 = {:.2f}\n".format(e)
            ff.write(temp_str)
            print(temp_str)
        ...
        a, b, c, d, e = check_p1('快检测台灯1米外.log')
        if 1000 < a:
            temp_str = "p1 = {:.2f}\n".format(e)
            ff.write(temp_str)
            print(temp_str)
        ...
        a, b, c, d, e = check_p2('快检测台灯1米外.log')
        if 1000 < a:
            temp_str = "p2 = {:.2f}\n".format(e)
            ff.write(temp_str)
            print(temp_str)
        ...
        ff.write('--------------台灯1米内---------------\n')
        print('--------------台灯1米内---------------')
        a, b, c, d, e = check_p0('快检测台灯1米内.log')
        if 1000 < a:
            temp_str = "p0 = {:.2f}\n".format(e)
            ff.write(temp_str)
            print(temp_str)
        ...
        a, b, c, d, e = check_p1('快检测台灯1米内.log')
        if 1000 < a:
            temp_str = "p1 = {:.2f}\n".format(e)
            ff.write(temp_str)
            print(temp_str)
        ...
        a, b, c, d, e = check_p2('快检测台灯1米内.log')
        if 1000 < a:
            temp_str = "p2 = {:.2f}\n".format(e)
            ff.write(temp_str)
            print(temp_str)
