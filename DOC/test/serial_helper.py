...
#####################################################################    
    ...
    core.add_button("ceil_setup0", label="吸顶R=2.5米", tip="0x00")
    core.add_same_line(spacing=10)
    core.add_button("ceil_setup1", label="吸顶R=3.5米", tip="0x01")
    core.add_same_line(spacing=10)
    core.add_button("wall_setup0", label="壁挂S=5米", tip="0x02")
    core.add_same_line(spacing=10)
    core.add_button("wall_setup1", label="壁挂S=7米", tip="0x03")
    core.add_same_line(spacing=10)
