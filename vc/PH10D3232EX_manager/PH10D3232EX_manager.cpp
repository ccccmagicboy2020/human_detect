// PH10D3232EX_manager.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CPH10D3232EX_managerApp, CWinApp)
	//{{AFX_MSG_MAP(CPH10D3232EX_managerApp)
...
/////////////////////////////////////////////////////////////////////////////
// CPH10D3232EX_managerApp construction

CPH10D3232EX_managerApp::CPH10D3232EX_managerApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CPH10D3232EX_managerApp object

CPH10D3232EX_managerApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CPH10D3232EX_managerApp initialization

BOOL CPH10D3232EX_managerApp::InitInstance()
{
	if (!AfxSocketInit())
	{
...
void CPH10D3232EX_managerApp::init_jlink()
{
	const char* sErr;
	U32 Core;
	char acBuffer[50];
...
int CPH10D3232EX_managerApp::ExitInstance() 
{
...
void CPH10D3232EX_managerApp::init_console()
{
	debugInit();
}
