// PH10D3232EX_burnDlg.cpp : implementation file
//
...
CPH10D3232EX_burnDlg::CPH10D3232EX_burnDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CPH10D3232EX_burnDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPH10D3232EX_burnDlg)
...
void CPH10D3232EX_burnDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPH10D3232EX_burnDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CPH10D3232EX_burnDlg, CDialog)
	//{{AFX_MSG_MAP(CPH10D3232EX_burnDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_CREATE()
...
/////////////////////////////////////////////////////////////////////////////
// CPH10D3232EX_burnDlg message handlers

BOOL CPH10D3232EX_burnDlg::OnInitDialog()
{
...
void CPH10D3232EX_burnDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CPH10D3232EX_burnDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CPH10D3232EX_burnDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

int CPH10D3232EX_burnDlg::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CPH10D3232EX_burnDlg::PostNcDestroy() 
{
...
void CPH10D3232EX_burnDlg::OnTimer(UINT nIDEvent) 
{
	switch (nIDEvent)
	{
	case 0:
...
void CPH10D3232EX_burnDlg::update_rtt_ch0()
{
	U32 read_num;
	char buf[1024];
...
void CPH10D3232EX_burnDlg::update_light_sensor()
{
	U32 aBuffer[2*20];
	int NumBytesRem;
	int i = 0;
...
void CPH10D3232EX_burnDlg::OnButton10() 
{
