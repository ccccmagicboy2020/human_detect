// PH10D3232EX_upload_verify.cpp : Defines the class behaviors for the application.
//
...
/////////////////////////////////////////////////////////////////////////////
// CPH10D3232EX_upload_verifyApp

BEGIN_MESSAGE_MAP(CPH10D3232EX_upload_verifyApp, CWinApp)
	//{{AFX_MSG_MAP(CPH10D3232EX_upload_verifyApp)
...
/////////////////////////////////////////////////////////////////////////////
// CPH10D3232EX_upload_verifyApp construction

CPH10D3232EX_upload_verifyApp::CPH10D3232EX_upload_verifyApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CPH10D3232EX_upload_verifyApp object

CPH10D3232EX_upload_verifyApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CPH10D3232EX_upload_verifyApp initialization

BOOL CPH10D3232EX_upload_verifyApp::InitInstance()
{
	if (!AfxSocketInit())
	{
	...
	CPH10D3232EX_upload_verifyDlg dlg;
	m_pMainWnd = &dlg;
...
void CPH10D3232EX_upload_verifyApp::init_jlink()
{
	const char* sErr;
	U32 Core;
	char acBuffer[50];
...
int CPH10D3232EX_upload_verifyApp::ExitInstance() 
{
...
void CPH10D3232EX_upload_verifyApp::init_console()
{
	debugInit();
}
