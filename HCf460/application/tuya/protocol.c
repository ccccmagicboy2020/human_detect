...
void load_ceiling_setup(int mode)
{
	...
	else if (mode == 1)		//1.5M
	{
		...
		upssa0.ppp.slow_time_times = 2.53f;
	...
	else if (mode == 3)		//2.5M
	{
		...
		upssa0.ppp.slow_time_times = 2.39f;
